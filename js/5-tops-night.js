...
function slideTN () {
    ...
    <div class="flex" style="position: absolute; top: 0; left: 0;" id="root-sub">
        ...
        ${framedObjComponent(`<a href='https://www.instagram.com/topsnight22/'><img src="images/topsnight/insta.png"></img></a>`, 
        ...
        ${framedObjComponent(`
            ...
            "Exhibit A: TOPS Night 2022 Intro", 125, 80,
            `<p>
        ...
        ${framedObjComponent(
            `<img src="images/topsnight/chatreplay.png"/>`,
            "Exhibit B: TOPS Night premiere, Jul 28, 2022",
            85, 100,
        )}
