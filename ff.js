...
you don't understand I can't just lvie. i can't just trust that i'll go to uni and be influenced by the right people and i'll be fine wherever i go. i have to try and try and try to be better, analyze my actions to see if i'm sticking to my goals. i cnat just listen to replacing guilt, i have to think about it in ever second of my waking time. 

i have to devote myself wholly to what im working on. i can't just turn in a mediocre paper, i have to bleed each sentence with every ounce of my soul.

and nothign can stop me or else i'll walllow in medicrity




// make each button play the scratch sound effect on hover. each button that is not of class "footer"
const buttons = document.querySelectorAll("button:not(.footer)");
console.log(buttons);
